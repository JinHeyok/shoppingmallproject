...
<!-- 2. 메인 컨텐츠  -->	
  <div class="seller-main">	
		<jsp:include page="seller/s_delivery.jsp" flush="true"></jsp:include> 	
  </div> <!-- end seller-main  -->
</div><!-- end container  -->
...
(function activePageLink(){
	...
	// 이부분을 바꾸면 된다. 1.dashboard 2.상품등록 3.재고관리 4.리뷰관리 5.Q&A 6.반품정보 7.배송관리 
	list_a[7].classList.add('activePage');
})();
